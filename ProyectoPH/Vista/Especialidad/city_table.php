...
<head>
	...
	{
		document.location.href = "updateCity.php?id=" + codigo;
	}
...
<   <h1 class="text-center mt-5 mb-4">Listado de Ciudades</h1>
	<a class="btn btn-primary" style="margin:10px;" href="newCity.php">Agregar Ciudad</a>
    ...
    <table class="table table-hover table-bordered table-dark" id="datosCiudad">
